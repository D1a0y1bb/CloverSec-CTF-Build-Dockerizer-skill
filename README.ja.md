...
<p align="center">
  ...
  <span> · </span>
  <a href="README.zh-CN.md"><strong>中国語互換エントリ</strong></a>
</p>
...
### v2.0.2：中国語デフォルト化とドキュメント全面強化

`v2.0.2` は実行時挙動を変えず、運用文書の品質を大幅に強化します。
...
| ファイル/ディレクトリ | 役割 |
|---|---|
| `README.md` | 中国語デフォルト完全マニュアル |
| `README.en.md` | 英語完全マニュアル |
| `README.ja.md` | 日本語完全マニュアル |
| `README.zh-CN.md` | 中国語互換エントリ |
| `VERSION` | 現在バージョン |
| `CHANGELOG.md` | 変更履歴 |
| `LICENSE` | ライセンス |
| `Build_test/` | 実例回帰ケース |
